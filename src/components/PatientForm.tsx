...
const PatientForm = () => {
    ...
    useEffect(() =>{
        if(activeId){
            const activedPatient = patients.filter(patient => patient.id === activeId)[0]
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5 mx-5">
        <h2 className="font-black text-center text-2xl">Seguimiento de Pacientes</h2>
        <p className="text-center font-bold text-lg mt-2 mb-10">Añade pacientes y {''}
            <span className="text-fuchsia-600">Administralos</span>
        </p>
        <form 
